...
class ProviderUserProjectConfigureService:
    ...
    def _handle_failed_configuration(self, provider_user_project: ProviderUserProject) -> None:
        ...
        provider_user_project.status = ProviderUserProjectStatus.FAILED
        provider_user_project.save()

    @transaction.atomic
    def configure(self, user_id: UUID, provider_user_project_id: UUID) -> None:
        logger.info(
        ...
        provider_user_project_configurator.configure(provider_user_project)
